...
# -----------------------------
    ...
    with tab2:
        ...
        if uploaded_image and st.button("Send Image", key="img_btn"):
            st.session_state.chat_history.append({"role": "user", "content": "🖼️ Sent an image"})
            try:
    ...
    with tab3:
        ...
        recorded_audio = mic_recorder(start_prompt="🎙️ Start Recording", stop_prompt="⏹️ Stop Recording", key="recorder")
